...
`https://puresdk.azurewebsites.net/cocoapods/sdk/versions/1.0.64.zip?key=INSERT_KEY_HERE`
...
`https://puresdk.azurewebsites.net/cocoapods/bluetooth/versions/1.0.64.zip?key=INSERT_KEY_HERE`.
